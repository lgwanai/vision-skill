# Hand-Drawn Storyboard Sheet

- **ID:** `ev-0121`
- **Source:** evolink (UI & Social Media Mockup)
- **Unified Category:** Social Media & UI
- **Author:** saniaspeaks_
- **Original:** https://x.com/saniaspeaks_/status/2050465100973191219

![Output 1](https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case121/output.jpg)
