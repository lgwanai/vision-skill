# Graphic Design Portfolio Mockup

- **ID:** `ev-0146`
- **Source:** evolink (UI & Social Media Mockup)
- **Unified Category:** Social Media & UI
- **Author:** abs_uiux
- **Original:** https://x.com/abs_uiux/status/2054594512983310572

![Output 1](https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/ui_case146/output.jpg)
