...
- **ID:** `ev-0040`
- **Source:** evolink (Other→Brand & Identity)
- **Unified Category:** Brand & Identity
- **Author:** chatcutapp
- **Original:** https://x.com/chatcutapp/status/2047228386117128475

![Output 1](https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/case_case61/output.jpg)
