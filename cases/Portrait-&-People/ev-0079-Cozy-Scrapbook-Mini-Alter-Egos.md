# Cozy Scrapbook Mini Alter Egos

- **ID:** `ev-0079`
- **Source:** evolink (Other→Portrait & People)
- **Unified Category:** Portrait & People
- **Author:** gold_force_guri
- **Original:** https://x.com/gold_force_guri/status/2050433982756721029

![Output 1](https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case79/output.jpg)
