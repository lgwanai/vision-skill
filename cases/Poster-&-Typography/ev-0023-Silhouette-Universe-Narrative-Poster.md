...
- **ID:** `ev-0023`
- **Source:** evolink (Other→Poster & Typography)
- **Unified Category:** Poster & Typography
- **Author:** MrLarus
- **Original:** https://x.com/MrLarus/status/2045418028733538620

![Output 1](https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case23/output.jpg)
