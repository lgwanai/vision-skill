# Interior Design Mood Board Generator

- **ID:** `ev-0083`
- **Source:** evolink (Other→Photography & Realism)
- **Unified Category:** Photography & Realism
- **Author:** GeekCatX
- **Original:** https://x.com/GeekCatX/status/2052949583563784620

![Output 1](https://raw.githubusercontent.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts/main/images/comparison_case83/output.jpg)
